export const bio = [
  ...
  "My roles prior to development work demanded that I recognize complex patterns and details in problems in order to draw big-picture conclusions, and reassembling that information in an accessible manner for clients. This ability lended to my success as a proficient and creative coder as I began to build and deploy my first applications.",
